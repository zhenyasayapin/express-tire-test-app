 ...
 */
final class Version20250726181358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_item (id SERIAL NOT NULL, product_id INT NOT NULL, cart_id INT NOT NULL, PRIMARY KEY(id))');
